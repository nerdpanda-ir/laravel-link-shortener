    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <x-partials.ok-messages-printer />
                ...
                <canvas class="my-4 w-100" id="myChart" style="display: block; box-sizing: border-box; height: 542px; width: 1285px;" width="1285" height="542"></canvas>
